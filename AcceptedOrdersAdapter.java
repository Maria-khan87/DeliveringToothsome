...
public class AcceptedOrdersAdapter extends RecyclerView.Adapter<AcceptedOrdersAdapter.ViewHolder> {
    ...
    public AcceptedOrdersAdapter(BawarchiDashboard activity, BawarchiOrders fragment, List<ScheduleItemModel> data) {
    ...
    @NonNull
    @Override
    public AcceptedOrdersAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {

        View view = mInflater.inflate(R.layout.b_order_item, viewGroup, false);

        return new AcceptedOrdersAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AcceptedOrdersAdapter.ViewHolder viewHolder, int i) {
        ...
        viewHolder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DialogOrderDetails dlg=new DialogOrderDetails(activity,fragment,datalist.get(i), StaticVariables.DIALOG_TYPE_ORDER_ACCEPTED);
                dlg.show();
            }
        });
