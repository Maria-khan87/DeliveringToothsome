...
public class CookingOrdersAdapters extends RecyclerView.Adapter<CookingOrdersAdapters.ViewHolder> {
...
public CookingOrdersAdapters(BawarchiDashboard activity, BawarchiOrders fragment, List<ScheduleItemModel> data) {
...
public class ViewHolder extends RecyclerView.ViewHolder {
    ...
    @NonNull
    @Override
    public CookingOrdersAdapters.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {

        View view = mInflater.inflate(R.layout.b_order_item, viewGroup, false);

        return new CookingOrdersAdapters.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull CookingOrdersAdapters.ViewHolder viewHolder, int i) {
    ...
    viewHolder.cardView.setCardBackgroundColor(activity.getResources().getColor(R.color.mt_orange));
        viewHolder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DialogOrderDetails dlg=new DialogOrderDetails(activity ,fragment,datalist.get(i),StaticVariables.DIALOG_TYPE_ORDER_COOKING);
                dlg.show();
            }
        });
    }
