...
public class ShippedOrdersAdapter extends RecyclerView.Adapter<ShippedOrdersAdapter.ViewHolder> {
    ...
    public ShippedOrdersAdapter(BawarchiDashboard activity, BawarchiOrders fragment, List<ScheduleItemModel> data) {
    ...
    @NonNull
    @Override
    public ShippedOrdersAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {

        View view = mInflater.inflate(R.layout.b_order_item, viewGroup, false);

        return new ShippedOrdersAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ShippedOrdersAdapter.ViewHolder viewHolder, int i) {
        ...
        viewHolder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DialogOrderDetails dlg=new DialogOrderDetails(activity,fragment,datalist.get(i), StaticVariables.DIALOG_TYPE_ORDER_SHIPPED);
                dlg.show();
            }
        });
    }
