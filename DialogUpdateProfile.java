...
public class DialogUpdateProfile extends Dialog {
    ...
    ProfileModel model;
    BawarchiProfile bawarchiProfileFragment;

    public DialogUpdateProfile(BawarchiDashboard activity, ProfileModel model, BawarchiProfile bawarchiProfileFragment) {
        super(activity);
        this.activity = activity;
        this.model = model;
        this.bawarchiProfileFragment = bawarchiProfileFragment;
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btn_addimg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                activity.currentStatus = EventModel.BAWARCHI_PROFILE;
    ...
    private String code = EventModel.BAWARCHI_PROFILE;
                ...
                if (response.isSuccessful()) {
                    try {
                        ...
                        if (datajson.get("RetVal").equals("1")) {
                            ...
                            bawarchiProfileFragment.getUserData();
